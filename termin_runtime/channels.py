...
``termin_server.channels``. Re-export shim — drops in slice 7.5.

``from termin_server.channels import *`` carries the public
...
from termin_server.channels import *  # noqa: F401, F403
import termin_server.channels as _src
