...
``termin_server.events``. Re-export shim — drops in slice 7.5.

``from termin_server.events import *`` carries the public
...
from termin_server.events import *  # noqa: F401, F403
import termin_server.events as _src
