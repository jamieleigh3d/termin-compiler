...
``termin_server.state``. Re-export shim — drops in slice 7.5.

``from termin_server.state import *`` carries the public
...
from termin_server.state import *  # noqa: F401, F403
import termin_server.state as _src
