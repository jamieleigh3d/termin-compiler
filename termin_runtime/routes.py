...
``termin_server.routes``. Re-export shim — drops in slice 7.5.

``from termin_server.routes import *`` carries the public
...
from termin_server.routes import *  # noqa: F401, F403
import termin_server.routes as _src
