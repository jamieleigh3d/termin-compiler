...
``termin_server.pages``. Re-export shim — drops in slice 7.5.

``from termin_server.pages import *`` carries the public
...
from termin_server.pages import *  # noqa: F401, F403
import termin_server.pages as _src
