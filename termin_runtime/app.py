...
``termin_server.app``. Re-export shim — drops in slice 7.5.

``from termin_server.app import *`` carries the public
...
from termin_server.app import *  # noqa: F401, F403
import termin_server.app as _src
